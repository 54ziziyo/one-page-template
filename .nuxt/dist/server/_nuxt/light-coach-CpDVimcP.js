...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const differentiators = [
      { icon: "🎯", title: "Results in 90 Days", body: "Every engagement has defined KPIs. Measurable impact or your investment back." },
      { icon: "🧠", title: "Science-Backed Method", body: "Grounded in behavioral research and evidence-based leadership frameworks." },
      { icon: "🤝", title: "Real Operator Experience", body: "Our coaches have held P&L responsibility, managed global teams, and led through crisis." }
    ];
    const programs = [
      {
        icon: "🌱",
    ...
    const processSteps = [
      { icon: "🔍", title: "Discovery Call", body: "A focused 30-min conversation to understand your world, challenges, and ambitions." },
      { icon: "📊", title: "Leadership Audit", body: "360° assessment of strengths, blindspots, and the one lever that will change everything." },
      { icon: "🗺️", title: "Precision Roadmap", body: "A 90-day action plan with clear milestones, built around your specific situation." },
      { icon: "⚡", title: "Weekly Execution", body: "Intensive sessions plus real-time support between meetings to keep momentum high." },
      { icon: "📈", title: "Measure & Compound", body: "Track hard metrics, lock in behavioral changes, and plan your next breakthrough." }
    ];
    const metricsList = [
    ...
    const testimonials = [
      {
        quote: `"Forté didn't just improve my leadership—they fundamentally changed how I think. Six months in, I was promoted to Chief Revenue Officer and our pipeline tripled."`,
        outcome: "+$43M",
    ...
    const contactDetails = [
      { icon: "📧", label: "Email Us", val: "hello@forteadvisory.com" },
      { icon: "📞", label: "Call Us", val: "+1 (888) 555-0192" },
      { icon: "📍", label: "Offices", val: "New York · San Francisco · London" }
    ];
    const footerNav = [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div></div><div class="hero__visual" data-v-04ae9e70><div class="hero__frame" data-v-04ae9e70><img class="hero__photo" src="https://images.unsplash.com/photo-1560250097-0b93528c311a?w=700&amp;q=85&amp;auto=format&amp;fit=crop&amp;crop=face" alt="Executive coach" data-v-04ae9e70><div class="hero__frame-overlay" data-v-04ae9e70></div><div class="hero__corner hero__corner--tl" data-v-04ae9e70></div><div class="hero__corner hero__corner--br" data-v-04ae9e70></div></div><div class="stat-float stat-float--a" data-v-04ae9e70><span class="sf-num" data-v-04ae9e70>94<small data-v-04ae9e70>%</small></span><span class="sf-lbl" data-v-04ae9e70>Promotion Rate</span></div><div class="stat-float stat-float--b" data-v-04ae9e70><span class="sf-icon" data-v-04ae9e70>🏆</span><div data-v-04ae9e70><span class="sf-num" data-v-04ae9e70>4.97<small data-v-04ae9e70>/5</small></span><span class="sf-lbl" data-v-04ae9e70>Client Rating</span></div></div><div class="stat-float stat-float--c" data-v-04ae9e70><span class="sf-num" data-v-04ae9e70>$2.1<small data-v-04ae9e70>B</small></span><span class="sf-lbl" data-v-04ae9e70>Value Unlocked</span></div></div></div><button class="hero__scroll-cue" data-v-04ae9e70><span class="scroll-line" data-v-04ae9e70></span><span class="scroll-label" data-v-04ae9e70>Scroll</span></button></section><div class="ticker" data-v-04ae9e70><div class="ticker__track" data-v-04ae9e70><!--[-->`);
      ...
      if (sent.value) {
        ...
        _push(`</button><p class="form-disclaimer" data-v-04ae9e70>🔒 Strictly confidential. No spam, no obligation.</p></form>`);
      }
      _push(`</div></div></div></section><footer class="footer" data-v-04ae9e70><div class="wrap footer__top" data-v-04ae9e70><div class="footer__brand" data-v-04ae9e70><span class="footer__emblem" data-v-04ae9e70>F</span><div data-v-04ae9e70><span class="footer__name" data-v-04ae9e70>FORTÉ <em data-v-04ae9e70>ADVISORY</em></span><span class="footer__tagline" data-v-04ae9e70>Transforming leaders. Building legacies.</span></div></div><div class="footer__cols" data-v-04ae9e70><!--[-->`);
      ...
      _push(`<!--]--></div></div><div class="wrap footer__bottom" data-v-04ae9e70><span data-v-04ae9e70>© 2025 Forté Advisory LLC. All rights reserved.</span><span data-v-04ae9e70>Photos: Unsplash (CC0 License)</span></div></footer></div>`);
    };
  }
};
...
export {
  lightCoach as default
};
//# sourceMappingURL=light-coach-CpDVimcP.js.map
